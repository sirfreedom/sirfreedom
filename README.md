...
<table width="100%">
  <!-- FILA 1: BACKEND Y FRONTEND -->
  <tr>
    <td width="50%" valign="top">
      <h3>🖥️ Technical BackEnd Skills</h3>
      <ul>
        <li><b>Lenguajes y Frameworks:</b> Vb .Net / C# / .NET (Desde v1.0 hasta .NET 9), Visual Basic 6, Java / Android Native, Node.js / Express.js</li>
        <li><b>APIs y Comunicación:</b> WCF / RESTful Api / Swagger / WebService, gRPC, Minimal APIs, JWT, OAuth 2.0, validacion CORS</li>
        <li><b>Mensajería y Arquitectura:</b> Microsoft Message Queue / Kafka, Microservicios (patrón SAGA y CQRS)</li>
        <li><b>Bases de Datos y ORM:</b> SQL Server (2000 → 2019 Cloud), Oracle (10 → 18 PL SQL), MongoDB, Cassandra, MySQL, PostgreSQL, GraphQL</li>
        <li><b>Acceso a Datos:</b> Entity Framework / ADO.NET / nHibernate / LinQ to Entity o Sql</li>
        <li><b>Firmware y Hardware:</b> C / C++, Arduino / Domótica / Electrónica</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🎨 Technical FrontEnd Skills</h3>
      <ul>
        <li><b>Frameworks y Librerías:</b> React (v16 a v19), Next.js 15.5, Angular 20, ASP.NET / MVC net</li>
        <li><b>Estado y Herramientas:</b> Zustand, npm, pnpm, nvm, TypeScript</li>
        <li><b>Diseño y Maquetación:</b> HTML4 / HTML5, CSS3 / CSS5, Sass, Bootstrap, Material UI, JavaScript, jQuery</li>
      </ul>
    </td>
  </tr>
  
  <!-- FILA 2: DEVOPS Y SOCIAL SKILLS -->
  <tr>
    <td width="50%" valign="top">
      <h3>⚙️ Technical DevOps & Management</h3>
      <ul>
        <li><b>Cloud & Infraestructura:</b> Azure Curso AZ-900 (IaaS / PaaS), Windows Server 2008-2016, Linux</li>
        <li><b>CI/CD & Herramientas:</b> Pipelines Azure / Azure DevOps, GitHub, GitLab, Configuración de Docker (Contenedores)</li>
        <li><b>Arquitectura y Calidad:</b> Hexagonal Architecture, DDD, SOLID, Clean Code, Value Object, Enterprise Architect, UML, Jira, Scrum, Agile</li>
        <li><b>Testing y Automatización:</b> Unit Test xUnit TDD, Automatización con Selenium, HtmlDocument, HtmlWeb, Figma, VisualStudio Code</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h3>🤝 Social Skills & Soft Skills</h3>
      <ul>
        <li>💡 Autodidacta</li>
        <li>👥 Trabajo en equipo</li>
        <li>🏃‍♂️ Scrum / Metodologías Ágiles</li>
        <li>💬 Asertividad</li>
        <li>🤝 Cooperación</li>
        <li>🧩 Resolución de conflictos</li>
        <li>👔 Negociador</li>
        <li>❤️ Empatía</li>
        <li>📢 Comunicador nato</li>
      </ul>
    </td>
  </tr>
</table>
